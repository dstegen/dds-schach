  ...
  returnObj.data = `
    ...
    <html lang="en">
      <head>
        ...
        <title>Stegens Schach-Server</title>
      </head>
      <body>
        <h1>Stegens Schach-Server</h1>
        <div id="chessboard" style="height: 100vH;">
          ...
          <div style=" height: 472px; padding: 20px 0;">
            <form action="/action" method="get">
              ...
              <br /><br />
              <input type="text" name="oldPosition" maxlength="2" required style="width: 20px;" onfocus="stopReload()" />
              <input type="text" name="newPosition" maxlength="2" required style="width: 20px;" onfocus="stopReload()" />
...
function row (obj, bgcolor, localRow) {
  ...
  for (let i=0; i<8; i++) {
    ...
    returnHTML += `
      <td style="background-color: ${bgcolor}; width: 80px; height: 80px;">
