...
const {setPlayer, getPlayer, checkPlayers, logoutPlayer, getPlayerNames} = require('../models/player');
...
function webView (request, response, wss, wsport) {
  if (authenticate.loggedIn(cookie(request).sessionid) || checkPlayers(obj)) {
